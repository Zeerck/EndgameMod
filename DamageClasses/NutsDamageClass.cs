...
namespace Endgame.DamageClasses
{
    public class NutsDamageClass : DamageClass
    {
        ...
        public override StatInheritanceData GetModifierInheritance(DamageClass damageClass)
        {
            ...
            return new StatInheritanceData(
                damageInheritance: 2f,
                critChanceInheritance: -0.8f,
                attackSpeedInheritance: 0f,
                armorPenInheritance: 4f,
        ...
        public override void SetDefaultStats(Player player)
        {
            ...
            player.GetCritChance<NutsDamageClass>() += 1;
            player.GetArmorPenetration<NutsDamageClass>() += 15;
