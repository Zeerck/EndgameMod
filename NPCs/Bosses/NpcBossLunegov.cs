...
namespace Endgame.NPCs.Bosses
{
    ...
    public class NpcBossLunegov : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            NPC.DeathSound = new SoundStyle("Endgame/Sounds/Custom/Borisich_mozhno_ne_pisat");
        ...
        public override void AI()
        {
            ...
            NPC.HitSound = new SoundStyle("Endgame/Sounds/Custom/Borisich_DOS");
            ...
            else if (NPC.ai[0] >= 350 && NPC.ai[0] < 1450.0 && !_standingHere)
            {
                if(!_noHighDefence)
                {
                    EndgameUtils.PlayCustomLocalDelaySound(NPC.position, "Endgame/Sounds/Custom/Borisich_ne_schitaetsa", 500);
                    _noHighDefence = true;
                }
        ...
        public override void BossLoot(ref string name, ref int potionType)
        {
            ...
            //SoundEngine.PlaySound(type: 50, Main.LocalPlayer.position, SoundLoader.GetSoundSlot(Mod, "Endgame/Sounds/Custom/Borisich_mozhno_ne_pisat"));
