...
namespace Endgame.Items.Weapons
{
	internal class TinNuts : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.SetDefault(Language.GetTextValue("Mods.Endgame.Items.Weapons.TinNutsName"));
			Tooltip.SetDefault(Language.GetTextValue("Mods.Endgame.Items.Weapons.TinNutsDescription", _maxTargets, delayBetweenHits, focusRadiusInBlocks));
			SacrificeTotal = 1;
		}
