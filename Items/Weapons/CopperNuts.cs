...
namespace Endgame.Items.Weapons
{
	internal class CopperNuts : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.SetDefault(Language.GetTextValue("Mods.Endgame.Items.Weapons.CopperNutsName"));
			Tooltip.SetDefault(Language.GetTextValue("Mods.Endgame.Items.Weapons.CopperNutsDescription", _maxTargets, delayBetweenHits, focusRadiusInBlocks));
			SacrificeTotal = 1;
		}
