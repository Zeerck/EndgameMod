...
namespace Endgame.Items.Weapons
{
	internal class TungstenNuts : ModItem
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DisplayName.SetDefault(Language.GetTextValue("Mods.Endgame.Items.Weapons.TungstenNutsName"));
			Tooltip.SetDefault(Language.GetTextValue("Mods.Endgame.Items.Weapons.TungstenNutsDescription", _maxTargets, delayBetweenHits, focusRadiusInBlocks));
			SacrificeTotal = 1;
		}
